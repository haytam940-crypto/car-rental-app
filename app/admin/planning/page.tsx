        ...
        <header className="bg-[#0d0d0d] border-b border-white/8 px-6 py-4 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1 bg-[#111] border border-white/10 rounded-xl p-1">
              <button onClick={prevMonth} className="p-1.5 text-gray-400 hover:text-gray-400 rounded-lg hover:bg-white/10 transition-colors">
                <ChevronLeft size={16} />
              </button>
              <span className="text-sm font-bold text-white px-3 min-w-[140px] text-center capitalize">
                {MONTHS_FR[month]} {year}
              </span>
              <button onClick={nextMonth} className="p-1.5 text-gray-400 hover:text-gray-400 rounded-lg hover:bg-white/10 transition-colors">
          ...
          <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center px-4">
            <div className="bg-[#111] border border-white/10 rounded-2xl w-full max-w-sm">
              <div className="flex items-center justify-between p-5 border-b border-white/8">
                ...
                <button onClick={() => setSelectedRes(null)} className="text-gray-500 hover:text-gray-400"><X size={18} /></button>
              </div>
